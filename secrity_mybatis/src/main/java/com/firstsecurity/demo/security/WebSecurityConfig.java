package com.firstsecurity.demo.security;

import com.firstsecurity.demo.security.authenticationProvider.VAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private VAuthenticationProvider provider;//自定义验证
    @Autowired
